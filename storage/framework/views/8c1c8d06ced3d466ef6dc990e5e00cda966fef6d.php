  ...
  <div id="wrapper">
        ...
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              ...
              <a href="<?php echo e(url('/')); ?>"><i class="ico icon-circled icon-bgdark icon-laptop active icon-3x"></i></a>
            </div>
          </div>
          <div class="span8">
    ...
    <section id="featured">
      ...
      <div class="camera_wrap" id="camera-slide">
        ...
        <!-- slide 1 here -->
        <div data-src="<?php echo e(asset('img/slides/camera/slide1/img1.jpg')); ?>">
          <div class="camera_caption fadeFromLeft">
            <div class="container">
              <div class="row">
                ...
                <div class="span6">
                  <img src="<?php echo e(asset('img/slides/camera/slide1/screen.png')); ?>" alt="" class="animated bounceInDown delay1" />
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- slide 2 here -->
        <div data-src="<?php echo e(asset('img/slides/camera/slide2/img1.jpg')); ?>">
          <div class="camera_caption fadeFromLeft">
            <div class="container">
              <div class="row">
                <div class="span6">
                  <img src="<?php echo e(asset('img/slides/camera/slide2/iMac.png')); ?>" alt="" />
                </div>
                <div class="span6">
            ...
            <div class="container">
              <div class="row">
                <div class="span12 aligncenter">
                  ...
                  <img src="<?php echo e(asset('img/slides/camera/slide3/browsers.png')); ?>" alt="" class="animated bounceInDown delay1" />
                </div>
              </div>
            </div>
          </div>
